...
**8. Restoranları Yıldız Sayısına Göre Sıralama:**
  ...
  * **Açıklama:** Kullanıcı websitesindeki bulunan tüm restoranları kullanıcıların verdiği yıldız sayısına göre (1-5 arasında) ortalama bir yıldız sayısı              hesaplanır. Hesaplanan bu yıldız sayısı ile, restoranları çoktan aza doğru sıralar.
